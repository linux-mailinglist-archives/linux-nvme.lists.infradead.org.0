...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id CBBB18ECF6
	for <lists+linux-nvme@lfdr.de>; Thu, 15 Aug 2019 15:35:18 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=XXIjgExzmlZqFsQOrDihbyGFQC3Qx3pmCKIb78kcQzQ=; b=Helpu000gGW/V/y0aWW8QFQLKK
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hyFuJ-0006PQ-4r; Thu, 15 Aug 2019 13:35:11 +0000
Received: from mail-il-dmz.mellanox.com ([193.47.165.129] helo=mellanox.co.il)
 by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
 id 1hyFt5-0005cw-5Y
 for linux-nvme@lists.infradead.org; Thu, 15 Aug 2019 13:34:03 +0000
Received: from Internal Mail-Server by MTLPINE1 (envelope-from
 israelr@mellanox.com)
 with ESMTPS (AES256-SHA encrypted); 15 Aug 2019 16:33:48 +0300
Received: from rsws50.mtr.labs.mlnx (rsws50.mtr.labs.mlnx [10.209.40.61])
 by labmailer.mlnx (8.13.8/8.13.8) with ESMTP id x7FDXmmr030419;
 Thu, 15 Aug 2019 16:33:48 +0300
From: Israel Rukshin <israelr@mellanox.com>
To: Linux-nvme <linux-nvme@lists.infradead.org>
Subject: [PATCH 2/5] nvme-rdma: Add TOS for rdma transport
Date: Thu, 15 Aug 2019 16:33:44 +0300
Message-Id: <1565876027-25092-4-git-send-email-israelr@mellanox.com>
...
X-CRM114-CacheID: sfid-20190815_063355_618298_A1DA53F6 
...
@@ -2045,7 +2047,8 @@ static struct nvme_ctrl *nvme_rdma_create_ctrl(struct device *dev,
